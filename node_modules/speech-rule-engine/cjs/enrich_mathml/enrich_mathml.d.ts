...
export declare function enrich(mml: Element, semantic: SemanticTree, options: Options): Element;
...
export declare function ascendNewNode(newNode: Element, semantic?: SemanticNode): Element;
