...
const case_collapsed_script_js_1 = require("./case_collapsed_script.js");
...
enrich_case_js_1.factory.push(...[
    ...
    {
        test: case_collapsed_script_js_1.CaseCollapsedScript.test,
        constr: (node) => new case_collapsed_script_js_1.CaseCollapsedScript(node)
    },
    {
