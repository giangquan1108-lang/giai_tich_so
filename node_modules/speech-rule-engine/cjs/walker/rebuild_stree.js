...
const WalkerUtil = __importStar(require("./walker_util.js"));
class RebuildStree {
    ...
    constructor(mathml) {
        ...
        if (isNaN(this.streeRoot.id)) {
            throw new engine_js_1.SREError(`Failed to rebuild semantic tree for\n ${mathml}`);
        }
    ...
    isEmpty(snode, node) {
        if (snode.type === semantic_meaning_js_1.SemanticType.EMPTY) {
            return true;
        }
        if (snode.type !== semantic_meaning_js_1.SemanticType.TEXT && snode.role !== semantic_meaning_js_1.SemanticRole.SPACE) {
            return false;
        }
...
//# sourceMappingURL=rebuild_stree.js.map