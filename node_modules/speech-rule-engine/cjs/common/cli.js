...
const System = __importStar(require("./system.js"));
...
class Cli {
    ...
    execute(input) {
        engine_js_1.EnginePromise.getall().then(() => {
            this.runProcessors_((proc, file) => this.output.write(System.file.processFile(proc, file) + '\n'), input);
        });
    }
    readline() {
    ...
    commandLine() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            commander
                ...
                .option('-J, --vis', 'Generate JSON for semantic visualization.', () => processor('vis'))
                ...
                .option('-W, --workerStructure', 'Return worker speech structure only.', () => processor('workerSpeechStructure'))
...
Cli.commander = system_external_js_1.SystemExternal.documentSupported || system_external_js_1.SystemExternal.webworker
    ? null
