...
class SemanticMathml extends semantic_parser_js_1.SemanticAbstractParser {
    ...
    constructor(options) {
        ...
        semantic_heuristic_factory_js_1.SemanticHeuristics.options = options;
        this.parseMap_ = new Map([
            ...
            [semantic_util_js_1.MMLTAGS.MPHANTOM, this.phantom_.bind(this)],
        ]);
        const meaning = {
    ...
    phantom_(node, children) {
        let newNode;
        if (children.length) {
            newNode = this.getFactory().makeUnprocessed(node);
            newNode.type = semantic_meaning_js_1.SemanticType.TEXT;
    ...
    fenced_(node, children) {
        ...
        semNodes.forEach((node) => {
            if (SemanticPred.isType(node, semantic_meaning_js_1.SemanticType.EMPTY)) {
