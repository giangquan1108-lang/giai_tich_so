...
semantic_heuristic_factory_js_1.SemanticHeuristics.add(new semantic_heuristic_js_1.SemanticTreeHeuristic('propagateSimpleFunction', (node) => {
    ...
    return node;
}, (_node) => semantic_heuristic_factory_js_1.SemanticHeuristics.options.domain === 'clearspeak'));
...
semantic_heuristic_factory_js_1.SemanticHeuristics.add(new semantic_heuristic_js_1.SemanticTreeHeuristic('simple2prefix', (node) => {
    ...
    return node;
}, (node) => semantic_heuristic_factory_js_1.SemanticHeuristics.options.modality === 'braille' &&
...
semantic_heuristic_factory_js_1.SemanticHeuristics.add(new semantic_heuristic_js_1.SemanticMultiHeuristic('op_with_limits', (nodes) => {
    ...
    return ((nodes[0].type === semantic_meaning_js_1.SemanticType.OPERATOR ||
        (nodes[0].type === semantic_meaning_js_1.SemanticType.IDENTIFIER &&
...
semantic_heuristic_factory_js_1.SemanticHeuristics.add(new semantic_heuristic_js_1.SemanticMultiHeuristic('bracketed_interval', (nodes) => {
    ...
    fenced.role = semantic_meaning_js_1.SemanticRole.INTERVAL;
    return fenced;
}, (nodes) => {
    const leftFence = nodes[0];
    const rightFence = nodes[1];
    ...
    if (content.length === 1 &&
        content[0].type === semantic_meaning_js_1.SemanticType.PUNCTUATED &&
...
function isInfty(node) {
    return (node.role === semantic_meaning_js_1.SemanticRole.INFTY ||
        (node.type === semantic_meaning_js_1.SemanticType.PREFIXOP &&
            node.childNodes[0].role === semantic_meaning_js_1.SemanticRole.INFTY));
}
semantic_heuristic_factory_js_1.SemanticHeuristics.add(new semantic_heuristic_js_1.SemanticTreeHeuristic('interval_heuristic', (node) => {
    node.role = semantic_meaning_js_1.SemanticRole.INTERVAL;
    return node;
}, (node) => {
...
function isPotentialInterval(node) {
    ...
    if (node.type !== semantic_meaning_js_1.SemanticType.FENCED ||
        (child === null || child === void 0 ? void 0 : child.type) !== semantic_meaning_js_1.SemanticType.PUNCTUATED ||
        (child === null || child === void 0 ? void 0 : child.childNodes.length) !== 3 ||
        (child === null || child === void 0 ? void 0 : child.contentNodes.length) !== 1 ||
        (child === null || child === void 0 ? void 0 : child.childNodes[1].role) !== semantic_meaning_js_1.SemanticRole.COMMA) {
        return false;
    }
...
semantic_heuristic_factory_js_1.SemanticHeuristics.add(new semantic_heuristic_js_1.SemanticTreeHeuristic('propagateInterval', (node) => {
    node.childNodes.forEach((child) => {
        if (isPotentialInterval(child)) {
            child.role = semantic_meaning_js_1.SemanticRole.INTERVAL;
        }
    });
    return node;
}, (node) => {
