...
const Alphabet = __importStar(require("../speech_rules/alphabet.js"));
exports.NamedSymbol = {
...
function initFences() {
    ...
    addFenceSecondary(parens, semantic_meaning_js_1.SemanticSecondary.PAREN);
    addFenceSecondary(curly, semantic_meaning_js_1.SemanticSecondary.CURLY);
    addFenceSecondary(brackets, semantic_meaning_js_1.SemanticSecondary.BRACKET);
    addFenceSecondary(ceil, semantic_meaning_js_1.SemanticSecondary.CEIL);
    addFenceSecondary(floor, semantic_meaning_js_1.SemanticSecondary.FLOOR);
}
function addFenceSecondary(codes, meaning) {
    for (const code of codes) {
        const symbol = String.fromCodePoint(parseInt(code, 16));
        exports.SemanticMap.Secondary.set(symbol, meaning);
        exports.SemanticMap.FencesSecondary.set(symbol, meaning);
    }
}
