...
exports.findMathmlTree = findMathmlTree;
...
function findMathmlTree(newNode, nodeList) {
    if (newNode.mathmlTree)
        return;
    const parentTrees = new Set();
    nodeList.forEach((x) => { var _a; return parentTrees.add(((_a = x.mathmlTree) === null || _a === void 0 ? void 0 : _a.parentElement) || null); });
