...
const IDS = new Map();
export function enrich(mml, semantic, options) {
    ...
    if (options.structure) {
        mml.setAttribute(EnrichAttr.Attribute.STRUCTURE, SemanticSkeleton.fromStructure(mml, semantic, options).toString());
    }
    Debugger.getInstance().generate(() => [
        'Semantic Tree\n',
...
export function ascendNewNode(newNode, semantic) {
    var _a;
