...
export declare class SemanticProcessor {
    ...
    static classifyMultiline(multiline: SemanticNode): SemanticNode;
    static classifyMultiline_(multiline: SemanticNode): void;
    ...
    static rewriteTrivialTable(table: SemanticNode): SemanticNode;
    private unwrapTrivialTable;
    private constructor();
    private implicitNode_;
    private infixNode_;
    private explicitMixed_;
    private concatNode_;
    private multiopNode_;
    private prefixNode_;
    private splitRoles;
    private splitOps;
    private splitSingles;
    private postfixNode_;
    private combineScripts_;
