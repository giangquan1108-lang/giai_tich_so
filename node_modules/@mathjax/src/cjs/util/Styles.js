...
function combineTRBL(name) {
    ...
    try {
        for (var children_1 = __values(children), children_1_1 = children_1.next(); !children_1_1.done; children_1_1 = children_1.next()) {
            ...
            var part = this.styles[this.childName(name, child)];
            if (!part) {
...
var Styles = (function () {
        ...
        get: function () {
            ...
            try {
                for (var _d = __values(Object.keys(this.styles)), _e = _d.next(); !_e.done; _e = _d.next()) {
                    ...
                    var pname = this.childName(this.parentName(parent_1), cname);
                    if (this.styles[name_2] &&
                        !this.styles[pname] &&
                        (!this.styles[parent_1] ||
    ...
    Styles.prototype.set = function (name, value) {
        ...
        var connect = Styles.connect[name];
    ...
    Styles.prototype.combineParent = function (name) {
        var e_12, _a;
        var _b;
        while (name.match(/-/)) {
            var cname = name;
            name = this.parentName(name);
            var connect_1 = Styles.connect[name];
            if (!Styles.connect[cname] &&
                !((_b = connect_1 === null || connect_1 === void 0 ? void 0 : connect_1.children) === null || _b === void 0 ? void 0 : _b.includes(cname.substring(name.length + 1)))) {
                break;
            }
            connect_1.combine.call(this, name);
        }
        if (!this.styles[name]) {
            return;
        }
        var connect = Styles.connect[name];
        try {
            for (var _c = __values((connect === null || connect === void 0 ? void 0 : connect.parts) || []), _d = _c.next(); !_d.done; _d = _c.next()) {
                var cname = _d.value;
    ...
    Styles.prototype.setStyle = function (name, value) {
        ...
        if ((_a = Styles.connect[name]) === null || _a === void 0 ? void 0 : _a.children) {
    ...
    Styles.prototype.childName = function (name, child) {
        ...
        if ((_a = Styles.connect[name]) === null || _a === void 0 ? void 0 : _a.subPart) {
            child += name.replace(/.*-/, '-');
            name = this.parentName(name);
        }
        return name + '-' + child;
