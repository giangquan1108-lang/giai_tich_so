...
new sm.CommandMap('macros', {
    ...
    SMALL: [BaseMethods_js_1.default.SetSize, 0.7],
    Small: [BaseMethods_js_1.default.SetSize, 0.8],
    footnotesize: [BaseMethods_js_1.default.SetSize, 0.8],
    small: [BaseMethods_js_1.default.SetSize, 0.9],
    normalsize: [BaseMethods_js_1.default.SetSize, 1.0],
    large: [BaseMethods_js_1.default.SetSize, 1.095],
    Large: [BaseMethods_js_1.default.SetSize, 1.2],
    LARGE: [BaseMethods_js_1.default.SetSize, 1.44],
    huge: [BaseMethods_js_1.default.SetSize, 1.728],
    Huge: [BaseMethods_js_1.default.SetSize, 2.074],
    ...
    bmod: [
        ...
        "\\mmlToken{mo}[lspace=\"".concat(THICKMATHSPACE, "\" rspace=\"").concat(THICKMATHSPACE, "\"]{mod}"),
    ],
