...
var WorkerHandler = (function () {
    ...
    WorkerHandler.prototype.Attach = function (item, speech, braille, structure) {
        ...
        try {
            for (var _c = __values(Object.entries(data.mactions)), _d = _c.next(); !_d.done; _d = _c.next()) {
                var _e = __read(_d.value, 2), id = _e[0], sid = _e[1];
        ...
        try {
            for (var _f = __values(adaptor.childNodes(container)), _g = _f.next(); !_g.done; _g = _f.next()) {
                var child = _g.value;
