...
function ExplorerMathItemMixin(BaseMathItem, toMathML) {
    ...
    return _a = (function (_super) {
            ...
            Object.defineProperty(BaseClass.prototype, "brailleNone", {
                get: function () {
...
function ExplorerMathDocumentMixin(BaseDocument) {
    ...
    return _a = (function (_super) {
            ...
            function BaseClass() {
                ...
                _this.tmpFocus = adaptor.node('mjx-focus', {
                    tabIndex: 0,
                    style: {
                        outline: 'none',
                        display: 'block',
