...
var FontData_js_2 = require("../common/FontData.js");
...
var ChtmlFontData = (function (_super) {
    ...
    ChtmlFontData.prototype.addDelimiterVPart = function (styles, c, part, n, v, HDW) {
        ...
        if (part !== 'ext') {
            ...
            fuzz = FontData_js_2.VFUZZ;
            var lh = Math.max(FontData_js_2.VFUZZ, h + d - FontData_js_2.VFUZZ);
            css['line-height'] = this.em0(lh);
            var D = h - lh / 2 - FontData_js_2.VFUZZ;
            if (D) {
                styles["mjx-stretchy-v".concat(c, " > mjx-ext > mjx-spacer")] = {
    ...
    ChtmlFontData.prototype.addDelimiterHStyles = function (styles, n, c, data) {
        ...
        if (data.ext) {
            styles["mjx-stretchy-h".concat(c, " > mjx-ext > mjx-spacer")]['letter-spacing'] =
                this.em(-data.ext - FontData_js_2.HFUZZ);
        }
    };
    ...
    ChtmlFontData.prototype.addCharStyles = function (styles, vletter, n, data) {
        ...
        styles[selector +
            (css['margin-left'] && !font
                ? ":not([class*=\"".concat(this.cssFontPrefix, "-\"])")
                : '')] = css;
    };
