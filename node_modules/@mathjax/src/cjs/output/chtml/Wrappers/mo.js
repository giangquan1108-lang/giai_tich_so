...
var FontData_js_2 = require("../FontData.js");
    ...
    return _b = (function (_super) {
            ...
            ChtmlMo.prototype.toCHTML = function (parents) {
                ...
                var symmetric = attributes.get('symmetric') &&
                    this.stretch.dir !== FontData_js_2.DIRECTION.Horizontal;
                var stretchy = this.stretch.dir !== FontData_js_2.DIRECTION.None;
            ...
            ChtmlMo.prototype.stretchHTML = function (chtml) {
                ...
                var styles = {};
                if (delim.dir === FontData_js_2.DIRECTION.Vertical) {
                    this.createAssembly(parts, stretch, stretchv, dom, h + d, FontData_js_1.VFUZZ, '\n');
                    dom.push(this.html('mjx-mark'));
                    styles.height = this.em(h + d);
                    styles.verticalAlign = this.em(-d);
                }
                else {
                    var ext = (delim.ext || 0) + FontData_js_1.HFUZZ;
            ...
            ChtmlMo.prototype.createAssembly = function (parts, sn, sv, dom, wh, ext, nl) {
                ...
                var _a = __read(parts.map(function (part) {
                    return part ? (nl ? part[0] + part[1] : part[2]) : 0;
                }), 4), WHb = _a[0], WHx = _a[1], WHe = _a[2], WHm = _a[3];
            ...
            ChtmlMo.prototype.createPart = function (part, data, n, v, dom, W, Wx, nl, Wb, We) {
                if (W === void 0) { W = 0; }
                if (Wx === void 0) { Wx = 0; }
                if (nl === void 0) { nl = ''; }
                if (Wb === void 0) { Wb = 0; }
                ...
                if (n) {
                    ...
                    if (part === 'mjx-ext' && (Wx || options.dx)) {
                        if (W < 0 && nl) {
                            dom.push(this.html(part, __assign(__assign({}, (font ? { class: font } : {})), { style: {
                                    'border-width': "".concat(this.em(Wb + W / 2), " 0 ").concat(this.em(We + W / 2)),
                                    'clip-path': 'none',
                                } })));
                            return;
                        }
                        if (!Wx) {
                            Wx = Math.max(FontData_js_1.HFUZZ, 2 * options.dx - FontData_js_1.HFUZZ);
                        }
        ...
        _b.kind = mo_js_2.MmlMo.prototype.kind,
        _b.styles = (_a = {
                'mjx-stretchy-h': {
            ...
            _a[['beg', 'ext', 'end', 'mid']
                .map(function (node) { return "mjx-stretchy-h > mjx-".concat(node); })
                .join(', ')] = {
                display: 'inline-block',
                width: 0,
                'text-align': 'right',
            },
            _a['mjx-stretchy-h > mjx-ext'] = {
            ...
            _a[['beg', 'ext', 'end', 'mid']
                .map(function (node) { return "mjx-stretchy-v > mjx-".concat(node); })
                .join(', ')] = {
                display: 'block',
                height: 0,
                margin: '0 auto',
            },
            _a['mjx-stretchy-v > mjx-ext > mjx-spacer'] = {
                display: 'block',
            },
            _a['mjx-stretchy-v > mjx-ext'] = {
