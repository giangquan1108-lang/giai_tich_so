...
var CommonWrapper = (function (_super) {
    ...
    CommonWrapper.prototype.getBreakNode = function (bbox) {
        ...
        var childNodes = ((_b = (_a = this.childNodes[0]) === null || _a === void 0 ? void 0 : _a.node) === null || _b === void 0 ? void 0 : _b.isInferred) || this.node.isKind('semantics')
    ...
    CommonWrapper.prototype.sideStyleSize = function (n) {
        var _a;
        var border = this.styleData.border;
        var padding = this.styleData.padding;
        var margin = this.styleData.margin;
        return (((_a = border === null || border === void 0 ? void 0 : border.width) === null || _a === void 0 ? void 0 : _a[n]) || 0) + ((padding === null || padding === void 0 ? void 0 : padding[n]) || 0) + ((margin === null || margin === void 0 ? void 0 : margin[n]) || 0);
    };
    ...
    CommonWrapper.prototype.getStyleData = function () {
        ...
        try {
            for (var _b = __values(BBox_js_1.BBox.boxSides), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                var m = this.styles.get('margin' + name_1);
                if (m) {
                    hasMargin = true;
