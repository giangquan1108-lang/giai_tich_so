...
var SvgWrapper = (function (_super) {
    ...
    SvgWrapper.prototype.handleStyles = function () {
        ...
        var margin = (((_b = this.styleData) === null || _b === void 0 ? void 0 : _b.margin) || [0, 0, 0, 0])[3];
        var border = (((_d = (_c = this.styleData) === null || _c === void 0 ? void 0 : _c.border) === null || _d === void 0 ? void 0 : _d.width) || [0, 0, 0, 0])[3];
        if (padding || border) {
            this.dx = padding + border;
        }
        if (margin) {
            var transform_1 = "translate(".concat(this.fixed(margin), ",0)");
            this.dom.forEach(function (node) {
                return _this.adaptor.setAttribute(node, 'transform', transform_1);
            });
        }
    };
    ...
    SvgWrapper.prototype.handleBorder = function () {
        ...
        if (!border)
            return;
        var margin = (_e = (_d = this.styleData) === null || _d === void 0 ? void 0 : _d.margin) !== null && _e !== void 0 ? _e : [0, 0, 0, 0];
        ...
        var isEmbellished = this.node.isEmbellished && !this.node.isKind('mo');
        try {
            for (var _f = __values(this.dom), _g = _f.next(); !_g.done; _g = _f.next()) {
                var dom = _g.value;
                var L = !n || !k ? 1 : 0;
                var R = !n || k === n ? 1 : 0;
                var bbox = isEmbellished ? this.getOuterBBox() : this.getLineBBox(k++);
                var h = bbox.h - margin[0] + f;
                var d = bbox.d - margin[2] + f;
                var w = bbox.w - margin[1] - margin[3] + f;
                var outerRT = [w, h];
                var outerLT = [-f, h];
                var outerRB = [w, -d];
                var outerLB = [-f, -d];
                ...
                var dx = L * this.dx;
                try {
                    for (var _h = (e_5 = void 0, __values([0, 1, 2, 3])), _j = _h.next(); !_j.done; _j = _h.next()) {
                        var i = _j.value;
