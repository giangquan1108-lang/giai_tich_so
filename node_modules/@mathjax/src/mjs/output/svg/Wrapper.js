...
export class SvgWrapper extends CommonWrapper {
    ...
    handleStyles() {
        ...
        const margin = (((_b = this.styleData) === null || _b === void 0 ? void 0 : _b.margin) || [0, 0, 0, 0])[3];
    ...
    handleBorder() {
        ...
        if (!border)
            return;
        const margin = (_c = (_b = this.styleData) === null || _b === void 0 ? void 0 : _b.margin) !== null && _c !== void 0 ? _c : [0, 0, 0, 0];
