...
import { VFUZZ, HFUZZ, } from '../FontData.js';
...
export const ChtmlMo = (function () {
    ...
    return _a = class ChtmlMo extends Base {
            ...
            createPart(part, data, n, v, dom, W = 0, Wx = 0, nl = '', Wb = 0, We = 0) {
                if (n) {
                    ...
                    if (part === 'mjx-ext' && (Wx || options.dx)) {
                        if (W < 0 && nl) {
                            dom.push(this.html(part, Object.assign(Object.assign({}, (font ? { class: font } : {})), { style: {
